...
# # # Pet
# # # 1,2
# # Pet.create!(user_id: 19, name: "Petey", cat_or_dog: "dog", breed: "Pitbull", weight: "120", vaccinations: "true", spay_or_neutered: "true", special_instructions: "Likes to have belly scratched.")
# # Pet.create!(user_id: 19, name: "Jolly", cat_or_dog: "dog", breed: "Cocker-Spaniel", weight: "45", vaccinations: "true", spay_or_neutered: "true", special_instructions: "Likes to eat watermelon.")
...
# user = User.create!(first_name: "tony", last_name: "montana", email: 'nextt@gmail.com', password: 'helloworld', password_confirmation: 'helloworld', phone: '3059569404', time_zone: 'Eastern Time (US & Canada)', kennel_or_customer: 'kennel')
# user.userID = user[:id]
# user.save

# kennel = Kennel.create!(user_id: User.last.id, name: 'Kennel One', zip: '34741', address: '123 Fake St', city: 'Kissimme', state: 'FL', cats_or_dogs: "both", mission_statement: "On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided. But in certain circumstances and owing to the claims of duty or the obligations of business it will frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he rejects pleasures to secure other greater pleasures, or else he endures pains to avoid worse pains.", email: "try@gmail.com", phone: "4079331234", sales_tax: 6.9)
# kennel.kennelID = kennel[:id]
# kennel.userID = kennel[:user_id]
# kennel.save
...
# Pet.create!(user_id: user.id, name: "Petey", cat_or_dog: "dog", breed: "Pitbull", weight: "120", vaccinations: "true", spay_or_neutered: "true", special_instructions: "Likes to have belly scratched.")
# Pet.create!(user_id: user.id, name: "Dafna", cat_or_dog: "cat", breed: "Britain", weight: "40", vaccinations: "true", spay_or_neutered: "true", special_instructions: "Likes to have belly scratched.")
# User.find_by(email: 'nexttt@gmail.com').update(kennel_or_customer: 'customer')

# Run.create!(kennel_id: Kennel.last.id, size_width: '12', size_length: '12', title: 'The Large Room', description: 'The largest room we have', indoor_or_outdoor: 'indoor', pets_per_run: 2, price: 90.0, weight_limit: 120, number_of_rooms: 2, type_of_pets_allowed: 'dog' )

# Amenity.create!(kennel_id: Kennel.last.id, title: "Doggy Ice-Cream", description: "A smooth peanut butter taste with large chunks of tuna.", price: 4.99)
# # # 2
...
# # # 3
# # reservation = Reservation.create!(kennel_id: 1, user_id: 4, customer_first_name: 'mary', customer_last_name: 'blossom', customer_email: 'mblossom@gmail.com', customer_phone: '4073214321', pet_ids: '[4]', run_ids: '[1]', check_in_date: '2017-01-24', check_out_date: '2017-01-25', total_price: 96.21, room_details: "[[\"The Large Room\", 90]]", completed: "false", transID: "09809796784876834")
