class RunsController < ApplicationController
  ...
  def run_params
    return params.require(:run).permit(:size_width, :size_length, :title, :description, :indoor_or_outdoor, :pets_per_run, :price, :weight_limit, :breeds_restricted, :number_of_rooms, :dates_unavailable, :type_of_pets_allowed)
  end
end
