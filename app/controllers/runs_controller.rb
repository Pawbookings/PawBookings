class RunsController < ApplicationController
  ...
  def run_params
    return params.require(:run).permit(:size_height, :size_width, :size_length, :title, :description, :indoor_or_outdoor, :private_or_shared, :pets_per_run, :price, :weight_limit, :breeds_restricted, :number_of_rooms, :dates_unavailable)
  end
end
