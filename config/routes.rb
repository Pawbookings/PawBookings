Rails.application.routes.draw do
  ...
  resources :customer_emergency_contacts, only: [:edit, :new, :create, :update, :destroy]
  resources :customer_vet_infos, only: [:edit, :new, :create, :update, :destroy]
  resources :hours_of_operations, only: [:edit, :update, :create, :destroy]
  resources :holidays
  resources :breed_restrictions
  resources :pets, only: [:index, :new, :edit, :create, :update, :destroy]
  resources :amenities, only: [:new, :create, :update, :destroy, :edit]
  resources :policies, only: [:new, :create, :update, :destroy, :edit]
  resources :photos, only: [:new, :create, :update, :destroy, :edit]
  ...
  # RunsController
    resources :runs, only: [:new, :create, :update, :destroy, :edit]
  ...
  # KennelsController
    resources :kennels, only: [:new, :create, :update, :show, :edit, :index, :destroy]
